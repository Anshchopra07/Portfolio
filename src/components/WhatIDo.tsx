        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building scalable and interactive web applications, focusing on full-stack development and robust backend architectures.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Creating intelligent solutions using machine learning and deep learning techniques for predictive modeling and automation.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
